<template lang="html">
  ...
  <div class="col text-left">
    ...
    <label for="description" class="col-sm-2 col-form-label">Artista</label>
        <div class="col-sm-6">
             <textarea name="description" class="form-control" placeholder="Artista" rows="3" v-model.trim="form.description">
                </textarea>
        </div>
      </div>
    ...
    <label for="album" class="col-sm-2 col-form-label">Código</label>
        <div class="col-sm-6">
             <textarea name="album" class="form-control" placeholder="Album" rows="3" v-model.trim="form.album">
                </textarea>
        </div>
      </div>
...
const path = `http://localhost:8000/api/v1.0/books/${this.bookId}/`
        ...
        swal("Disco actualizado exitosamente", "", "success")
